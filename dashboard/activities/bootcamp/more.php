...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h4 class="m-0 font-weight-bold text-danger">Members</h4> <br>
            ...
            <div class="table-responsive">
                <table class="table table-bordered display nowrap" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th>
                            <h6 class="m-0 font-weight-bold text-danger">Activity: <?php
                        ...
                        <th>
                            ...
                            ?>
                            <img class=" rounded" src="<?php echo $uri; ?>/dashboard/images/client-photos/<?php echo $logo; ?>" alt="" width="200">
                        </th>
                    </tr>
                    <tr>
                        <th>Name</th>
