...
//attendance monthly
  try {
       $.ajax({
            type:'GET',
            url:'http://clientzone.velocityhealth.co.za/dashboard/activities/getData/bar/index.php?activity=1',
...
//attendance (yearly)
  try {
    ...
    $.ajax({
            type:'GET',
            url:'http://clientzone.velocityhealth.co.za/dashboard/activities/getData/chart/index.php?activity=1',
            success:function(response){
                var data = JSON.parse(response);
                console.log(data.attend);
